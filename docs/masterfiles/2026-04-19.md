...
**Date:** 2026-04-19
**Generated:** 2026-04-19T22:21:05.424Z
**Git HEAD:** `006c60749bafe0ad9cf9d37c52e870449be2757b`
**Branch:** `main`
...
```
006c607 (HEAD -> main, origin/main) Consistency: fix 2 sub-wave drift cases caught by audit
6cac2ef Macro wave card: fix progress bar under macroOverride
342c22b Targets panel: rename to Wave Targets + clarify ST as sub-wave waypoints
6c7503f Macro Targets: drop misleading per-coin timeframe suffix
c9e0bbc Merlin Prediction: clarify technical vs macro trend
e647eff Merlin Prediction: multi-timeframe macro trend (Monthly/Weekly/Daily)
1836333 Fix W3 100% bug + remove Masterpiece label
ca163b3 Apply macroOverride to chart marker label + dedupe macro cache var
267fa76 Consolidate macro cache + apply override to table wave column
d715029 Fix Wave Map W4 inconsistency: macroOverride now drives waveStatus + GW desc
a98db15 Apply macroOverride to fetchPriceTargets HBAR/symbol badge — fix W4 vs W3 inconsistency
72829ee Rename 'Long-term'/'LT' label to 'Projected Long Term Top' across all macro target panels
58779d7 Add macroOverride system for cross-panel wave consistency
ef85491 fix(vercel): serve /data/*.json statically (was falling through to SPA)
61ac954 fix(dashboard): move Macro Targets row to top of Macro Wave Reis card for visibility
1d4478d refactor(dashboard): thorough macro targets sweep across all panels
54a2740 feat(dashboard): add Macro Targets row to Koersdoelen + Macro Wave Reis
1507eae feat(dashboard): remove Kronos signals card, sync GW3 koersdoelen with DefendDark
8274e9a feat(defenddark): render per-coin Macro Insight panel under Wave Map
a504a0d fix(defenddark-scan): use old.reddit.com RSS to bypass GH Actions IP block
0e20a9b feat(defenddark): zero-risk public scan via GitHub Actions
84f8003 feat(defenddark): cloud-side Discord monitoring + daily reconciliation
98b667d fix(kronos): backfill target1 + initialQty voor pre-trail posities
4c0925c feat(kronos): trail-stop strategie gelijk aan paper-engine + TP op dashboard
4ece825 feat(kronos): realistische fees, slippage en funding
8069d50 ui: hernoem 'Kronos Test Signals' → 'Kronos Signals'
534bb9e ui(trading): port live Binance WS ticker + groen/rood naar /trading
9065f72 ui(kronos): live ticker via Binance WS + groen/rood theming
ae88b92 fix(kronos): multi-source live price (Coinbase → Binance → Kronos)
86efdf0 fix(kronos): live mark-to-market via Binance ticker
0ba1a2f ui(index): voeg Kronos Test Signals card toe onderaan dashboard
a8c594e ui: verplaats Kronos Test Signals card naar onderaan dashboard
1195c75 feat(kronos): isolated €1000 paper bot + dashboard section
156e65d kronos: add clear-kronos action to remove paper_kronos positions
8c668bc daily-report: fix balance calc + group positions by bot
8ee0f1c kronos: paper-execute mode + manage loop
a37af97 portfolio-state: daily report mode + ntfy push
2bd7341 kronos: add signal-generator mode + 30-min cron
262ec1a paper-engine: EMA200 regime filter as Kronos fallback
abecf87 paper-engine: stricter Kronos veto for SELL signals
9439db3 paper-engine: react to EXIT-confluence signals on open positions
46c57cf feat(universe+1H): expand 6→12 tokens live, add 1H timeframe to backtest
d4667ed test(backtest): voeg STARS-2+ en STARS-2+TREND varianten toe
f376e94 fix(ui): auto-migreer oude 33/3 defaults naar nieuwe 25/4
9b6c546 tune(risk): optimale defaults — 25% cap / 4 posities / 1% base risk
8702583 docs(ui): verduidelijk Position Size = max cap, niet vaste size
ae7f135 feat(ntfy): Monthly Swing → eigen topic + filter-tag
fb7b713 chore(ntfy): backtest-agent daily report → labo topic
abc096b style: verwijder win/loss cirkel-emojis uit trade tables
65ee3dc style: vervang vierkante check/cross emojis door ronde cirkels
16bedb2 feat: 'Maandelijks resultaat' sectie in trade log (compounded %)
563c579 feat: one-shot backfill script voor trail-data op bestaande trades
0981b33 feat: trail-details in trade log (initial stop, final stop, peak, breakeven)
f939b01 feat: 'Totalen per token' sectie in trade log
0ac536f feat: ntfy push op CLOSE (stop-loss, target, trailing, partial, time-exit)
8bcd4d4 fix: sluit 'trade gesloten dan terug open' flicker bug
e780099 feat: weekly project masterfile via GitHub Actions
3fc7c6b security: ntfy topic roteren naar onraadbare naam (rogue-bot lockout)
...
```
.env.prod
.github/workflows/daily-report-cron.yml
.github/workflows/defenddark-public-scan.yml
.github/workflows/defenddark-reconcile-cron.yml
.github/workflows/kronos-signals-cron.yml
...
backtest-kronos.js
data/defenddark_macro.json
docs/github-actions-setup/paper-engine-cron.yml
docs/masterfiles/2026-04-16.md
ew-params.json
index.html
kronos_server.py
package-lock.json
package.json
paper-trading.html
scripts/backfill-trail.js
scripts/defenddark-public-scan.js
scripts/generate-masterfile.js
signal-params.json
vercel.json
```
...
{
  "ok": true,
  "ts": "2026-04-19T22:21:06.625Z",
  "state": {
    "_version": 1,
    "_updated": "2026-04-19T22:03:53.265Z",
    "balance": 10140.333703014821,
    "startBalance": 10000,
    "startDate": 1776193141820,
    "peakEquity": 10143.781718839777,
    "lastRun": 1776636233172,
    "lastSignals": {
      "SOL": {
        "time": 1776110400000,
        "type": "BUY",
    ...
    "portfolioValue": 10140.333703014821,
    "totalAtRisk": 0,
    "openPositions": 0
  },
  "positions": [],
  "trades": [
    {
      ...
      "trail": {
        "initialStop": 1.18920645,
        "finalStop": 1.1905145770949999,
        "target": 1.1214844,
        "target1": 1.136599998,
        "breakeven": false,
        "peakPrice": 1.16305,
        "peakPct": -0.32577345570842475,
        "atr": 0.015397857142857177,
        "_reconstructed": true
      }
    },
    {
      ...
      "trail": {
        ...
        "breakeven": true,
        "peakPrice": 75.69,
        "peakPct": 6.3772550210731875,
        "atr": 1.1823571428571416,
        "_reconstructed": true
      }
    },
    {
      ...
      "exitPrice": 533.6853023045118,
      "amount": 4.760837920283912,
      "sizeUsd": 2500,
      "pnl": -52.14119777127647,
      "pnlPct": -2.085647910851059,
      "stars": 5,
      "openTime": 1776259626523,
      "closeTime": 1776364023809,
      "reason": "Stop-Loss",
      "fees": {
        "exit": 6.351973061773756,
        "spread": 0,
        "slippage": 1.9145819410492804,
        "entryFee": 2.5
      },
      "trail": {
        "initialStop": 533.28315,
        "finalStop": 533.6853023045118,
        "target": 500.70390000000003,
        "target1": 510.2593512,
        "breakeven": false,
        "peakPrice": 523.21,
        "peakPct": 0.2635432123425096,
        "atr": 5.467142857142854,
        "_reconstructed": true
      }
    },
    {
      ...
      "side": "LONG",
      "entryPrice": 71.1524282,
      "exitPrice": 74.84011678226426,
      "amount": 35.10069948673937,
      "sizeUsd": 2500,
      "pnl": 117.87309760492084,
      "pnlPct": 4.714923904196834,
      "stars": 5,
      "openTime": 1776259626407,
      "closeTime": 1776365172831,
      "reason": "Trailing Stop",
      "fees": {
        "exit": 6.567351121816845,
        "spread": 0,
        "slippage": 47.414112497337946,
        "entryFee": 5
      },
      "trail": {
        "initialStop": 69.09578499999999,
        "finalStop": 74.84011678226426,
        "target": 74.678535,
        "target1": 73.26809228,
        "breakeven": true,
        "peakPrice": 75.69,
    ...
    {
      "id": "1776429814253_qbfz4w",
      "bot": "paper_4h",
      "token": "LINK",
      "side": "LONG",
      "entryPrice": 8.08986683882962,
      "exitPrice": 8.280638552996676,
      "amount": 159.90395062801272,
      "sizeUsd": 1296.8437770259738,
      "pnl": 23.95277427495834,
      "pnlPct": 1.8470053756119154,
      "stars": 5,
      "openTime": 1776429814253,
      "closeTime": 1776435032220,
      "reason": "Trailing Stop",
      "fees": {
        "exit": 3.310267045866998,
        "spread": 0,
        "slippage": 28.183345400271655,
        "entryFee": 3.2421094425649346
      },
      "trail": {
        "initialStop": 7.471853,
        "finalStop": 8.104386838829619,
        "target": 8.627962,
        "target1": 8.412723935531847,
        "breakeven": true,
        "peakPrice": 8.311,
        "peakPct": 2.733458604151413,
        "atr": 0.14520000000000013
      }
    }
  ],
  "equity": [
    ...
    },
    {
      ...
      "byBot": {
        "paper_4h": 9987.63324353889
      }
    },
    {
      "time": 1776260116744,
      "value": 9977.876413970238,
      "byBot": {
        "paper_4h": 9977.876413970238
      }
    },
    {
      "time": 1776261510416,
      "value": 9979.386099447776,
      "byBot": {
        "paper_4h": 9979.386099447776
      }
    },
    {
      "time": 1776262767870,
...
```json
{
  ...
  "stats": {
    ...
    "totalPnl": -722.5087029272876,
    "returnPct": -7.384058887173815,
    "maxDrawdown": 0.09365094620172051
  },
  "trades": [
    {
      "id": "HBAR_71",
      "token": "HBAR",
      "side": "LONG",
      "qty": 17117.897075803092,
      "entryPrice": 0.08944010342857144,
      "sizeUsd": 1534.8636440495932,
      ...
      "partialClosed": false,
      "breakeven": true,
      "entryFee": 3.837159110123983,
      "accruedFunding": 0.8441750042272763,
      "exitPrice": 0.08956219942097009,
      "pnl": -5.579923757802614,
    ...
    },
    {
      ...
      "token": "HBAR",
      "side": "LONG",
      "qty": 23143.719983138373,
      "entryPrice": 0.092654166,
      "sizeUsd": 2149.7364142107467,
      ...
      "partialClosed": false,
      "breakeven": true,
      "entryFee": 5.374341035526867,
      "accruedFunding": 0.10748682071053733,
      "exitPrice": 0.09444106565770286,
      "pnl": 15.258435167043128,
      "pnlPct": 1.4195633535514263,
    ...
    },
    {
      ...
      "token": "HBAR",
      "side": "LONG",
      "qty": 11571.859991569187,
      "entryPrice": 0.092654166,
      "sizeUsd": 1074.8682071053734,
      "stop": 0.09440785714285714,
      "initialStop": 0.0870028,
      "target": 0.09596357142857143,
      "target1": 0.09463980925714285,
      ...
      "partialClosed": true,
      "breakeven": true,
      "entryFee": 2.6871705177634335,
      "accruedFunding": 0.10748682071053733,
      "exitPrice": 0.09420960064285715,
      "pnl": 12.586650624163964,
      "pnlPct": 1.170994782519421,
      "closeTime": 1770883200000,
      "reason": "Trailing Stop"
    },
    {
      ...
      "token": "ETH",
      "side": "LONG",
      "qty": 0.6528962535988558,
      "entryPrice": 2128.4920726666664,
      "sizeUsd": 1393.1674186054438,
      ...
      "partialClosed": false,
      "breakeven": false,
      "entryFee": 3.4829185465136097,
      "accruedFunding": 2.1594094988384387,
      "exitPrice": 2047.3704575603997,
      "pnl": -59.78871838895891,
    ...
    },
    {
      ...
      "token": "XRP",
      "side": "LONG",
      "qty": 1314.0295355841972,
      "entryPrice": 1.4175575999999999,
      "sizeUsd": 1867.3810073101242,
      "stop": 1.4375250000000002,
      "initialStop": 1.3375785,
      "target": 1.475625,
      "target1": 1.4523980399999998,
      "atr": 0.02384999999999999,
      "stars": 4,
      "openTime": 1771027200000,
      "highWaterMark": 1.4733,
      "lowWaterMark": 1.4175575999999999,
      "partialClosed": false,
      "breakeven": true,
      "entryFee": 4.668452518275311,
      "accruedFunding": 0.18673810073101244,
      "exitPrice": 1.450800402156,
      "pnl": 17.123792456807383,
      "pnlPct": 1.8339902130067622,
      "closeTime": 1771056000000,
      "reason": "Target1 (50%)"
    },
    {
      "id": "XRP_110",
      "token": "XRP",
      "side": "LONG",
      "qty": 657.0147677920986,
      "entryPrice": 1.4175575999999999,
      "sizeUsd": 933.6905036550621,
      "stop": 1.4375250000000002,
      "initialStop": 1.3375785,
      "target": 1.475625,
      "target1": 1.4523980399999998,
      ...
      "partialClosed": true,
      "breakeven": true,
      "entryFee": 2.3342262591376555,
      "accruedFunding": 0.18673810073101244,
      "exitPrice": 1.4359437225,
      "pnl": 7.3871371672948785,
      "pnlPct": 0.7911762129288985,
      "closeTime": 1771056000000,
      "reason": "Trailing Stop"
    },
    {
      ...
      "token": "SOL",
      "side": "LONG",
      "qty": 29.15484078929979,
      "entryPrice": 85.18711378571429,
      "sizeUsd": 2489.8413430801656,
      "stop": 85.38118521428572,
      "initialStop": 76.27669999999999,
      "target": 89.96178571428571,
      "target1": 88.05191694285715,
      "atr": 1.9407142857142827,
      "stars": 4,
      "openTime": 1771027200000,
      "highWaterMark": 87.36,
      "lowWaterMark": 85.18711378571429,
      "partialClosed": false,
      "breakeven": true,
      "entryFee": 6.224603357700414,
      "accruedFunding": 0.24898413430801658,
      "exitPrice": 85.30386096936407,
      "pnl": -9.038409018977921,
      "pnlPct": -0.363011444247149,
      "closeTime": 1771056000000,
      "reason": "Trailing Stop"
    },
    {
      ...
      "side": "SHORT",
      "qty": 1509.8298447701,
      "entryPrice": 1.6474482538095236,
      "sizeUsd": 2493.600542672687,
      "stop": 1.6046714285714285,
      "initialStop": 1.6905714285714286,
      "target": 1.3479459,
      "target1": 1.4677468415238095,
      "atr": 0.03439285714285715,
      "stars": 5,
      "openTime": 1771128000000,
      "highWaterMark": 1.6474482538095236,
      "lowWaterMark": 1.5634,
      "partialClosed": false,
      "breakeven": true,
      "entryFee": 6.234001356681717,
      "accruedFunding": -0.12468002713363435,
      "exitPrice": 1.606474071161005,
      "pnl": 49.56628622739232,
      "pnlPct": 1.9877396310744408,
      "closeTime": 1771142400000,
      "reason": "Trailing Stop"
    },
    {
      "id": "BTC_125",
      "token": "BTC",
      "side": "SHORT",
      "qty": 0.03700852461337826,
      "entryPrice": 67545.471,
      "sizeUsd": 2506.0232842363184,
      "stop": 67430.95964285714,
      "initialStop": 71323.4631,
      "target": 
```
...
### api/_lib/portfolio.js (372 lines)
...
const MIN_RR = 0.5;
const MAX_POSITIONS = 4;                 // 4×25% cap = 100% max blootstelling, betere spreiding over 6-token universe
...
### api/backtest-agent.js (953 lines)
...
### api/backtest-parity.js (83 lines)
...
### api/portfolio-state.js (302 lines)
...
const TOKENS = ['BTC','ETH','SOL','BNB','HBAR','XRP','AVAX','LINK','ADA','DOT','POL','DOGE'];
...
async function buildDailyReport() {
  ...
  try {
    ...
    if (kStateRaw) {
      ...
      const kPnl = kPv - (kState.startBalance || 1000);
      const kPnlPct = (kPnl / (kState.startBalance || 1000)) * 100;
  ...
  if (kronosBlock) {
    ...
    lines.push('');
    lines.push(`── 🧪 Kronos Test (€${(kb.kState.startBalance || 1000).toFixed(0)} base) ──`);
...
const KRONOS_START_BALANCE = parseFloat(process.env.KRONOS_START_BALANCE || '1000');
const KRONOS_TRADE_SIZE = parseFloat(process.env.KRONOS_TRADE_SIZE || '100');   // €100 / trade (10% of capital)
...
async function kLoadState() {
  const raw = await redis.get('kronos_paper:state');
  if (!raw) return {
...
async function kSaveState(s) {
  ...
  return redis.set('kronos_paper:state', JSON.stringify(s));
}
async function kLoadPositions() {
  const raw = await redis.get('kronos_paper:positions');
  if (!raw) return {};
  return typeof raw === 'string' ? JSON.parse(raw) : raw;
}
async function kSavePositions(p) {
  return redis.set('kronos_paper:positions', JSON.stringify(p));
}
async function kRecordTrade(trade) {
  await redis.lpush('kronos_paper:trades', JSON.stringify(trade));
  await redis.ltrim('kronos_paper:trades', 0, 199);
}
async function kListTrades(limit = 50) {
  const raw = await redis.lrange('kronos_paper:trades', 0, limit - 1);
  return (raw || []).map(t => typeof t === 'string' ? JSON.parse(t) : t);
}
...
async function executeKronosTrades(signals) {
  const opened = [];
  const skipped = [];
  ...
  for (const sig of signals) {
    if (sig.stars < KRONOS_MIN_STARS_TRADE) { skipped.push(`${sig.token}: < ${KRONOS_MIN_STARS_TRADE}★`); continue; }
    if (openList.length + opened.length >= KRONOS_MAX_OPEN) { skipped.push(`${sig.token}: max ${KRONOS_MAX_OPEN} open bereikt`); continue; }
    if (openList.find(p => p.token === sig.token) || opened.find(o => o.token === sig.token)) {
      skipped.push(`${sig.token}: al open`); continue;
    }
    const signalPrice = Number(sig.current);
    if (!signalPrice) { skipped.push(`${sig.token}: geen current price`); continue; }
    if (state.balance < KRONOS_TRADE_SIZE) { skipped.push(`${sig.token}: balance ${state.balance.toFixed(2)} < trade size ${KRONOS_TRADE_SIZE}`); continue; }

    const side = sig.type === 'BUY' ? 'LONG' : 'SHORT';
    const sizeUsd = KRONOS_TRADE_SIZE;
    // ── Realistische entry-fill: spread + slippage + venue premium + adverse tick
    const atrPct = KRONOS_STOP_PCT / 100;   // ruwe vol-proxy ≈ stop-afstand
    const entryPrice = fillPrice(signalPrice, side, 'ENTRY', sig.token, {
      atrPct, sizeUsd, stochastic: true,
    });
    const entryFee = feeFor(sizeUsd, sig.token);
    const slippageCost = Math.abs(entryPrice - signalPrice) * (sizeUsd / entryPrice);
    // qty op basis van effectieve cash (na fee), zo gedraagt het zich als echte broker
    const effectiveCash = sizeUsd - entryFee;
    const qty = effectiveCash / entryPrice;
...
async function kClosePosition(state, positions, pos, triggerPrice, reason, partialPct = 1.0) {
  ...
  const exitPrice = fillPrice(triggerPrice, pos.side, 'EXIT', pos.token, {
    atrPct, sizeUsd: closeSizeUsd, stochastic: true,
  });
  let grossPnl;
  if (pos.side === 'LONG') grossPnl = (exitPrice - pos.entryPrice) * closeQty;
  else grossPnl = (pos.entryPrice - exitPrice) * closeQty;
  ...
  const exitFee = feeFor(Math.abs(exitPrice * closeQty), pos.token);
  const exitSlippage = Math.abs(exitPrice - triggerPrice) * closeQty;
  const funding = computeFunding({
    pos: { ...pos, sizeUsd: closeSizeUsd },
    periodMs: Date.now() - pos.openTime,
  });
  const netPnl = grossPnl - exitFee - funding;
  const pnlPct = (netPnl / closeSizeUsd) * 100;

  state.balance += closeSizeUsd + netPnl;

  if (partialPct >= 0.999) {
    // Volledig sluiten — trade record maken en positie verwijderen
    const trade = {
      ...pos,
      exitPrice, triggerPrice,
      grossPnl, pnl: netPnl, pnlPct, reason,
      fills: {
        ...(pos.fills || {}),
        exitFee, exitSlippage, funding,
        totalCosts: (pos.fills?.entryFee || 0) + exitFee + (pos.fills?.slippageCost || 0) + exitSlippage + funding,
      },
      closeTime: Date.now(),
    };
    delete positions[pos.id];
    await kRecordTrade(trade);
    return { full: true, reason, exitPrice, grossPnl, netPnl, pnlPct, exitFee, funding };
  }

  // Partial — qty + sizeUsd reduceren, partial-trade record opslaan
  pos.qty -= closeQty;
  pos.sizeUsd -= closeSizeUsd;
  pos.partialClosed = true;
  pos.partialClosedAt = Date.now();
  pos.realizedPnl = (pos.realizedPnl || 0) + netPnl;

  const partialTrade = {
    ...pos,
    qty: closeQty, sizeUsd: closeSizeUsd,
    exitPrice, triggerPrice,
    grossPnl, pnl: netPnl, pnlPct,
    reason: reason + ' (partial ' + Math.round(partialPct*100) + '%)',
    fills: { exitFee, exitSlippage, funding, partial: true },
    closeTime: Date.now(),
  };
  await kRecordTrade(partialTrade);
  return { full: false, reason, exitPrice, grossPnl, netPnl, pnlPct, exitFee, funding };
}
...
async function manageKronosPositions(currentPrices) {
  const state = await kLoadState();
  const positions = await kLoadPositions();
  const openList = Object.values(positions);
  const closed = [];
  ...
  for (const pos of openList) {
    ...
    // 1. Water marks (proxy voor wicks tussen cron-runs door)
    if (pos.side === 'LONG') {
      if (!pos.highWaterMark || live > pos.highWaterMark) pos.highWaterMark = live;
      if (!pos.lowWaterMark  || live < pos.lowWaterMark)  pos.lowWaterMark  = live;
    } else {
      if (!pos.lowWaterMark  || live < pos.lowWaterMark)  pos.lowWaterMark  = live;
      if (!pos.highWaterMark || live > pos.highWaterMark) pos.highWaterMark = live;
    }
    ...
    // 5. Partial close op target1 (50%)
    if (!pos.partialClosed && pos.target1) {
      const hit = pos.side === 'LONG' ? live >= pos.target1 : live <= pos.target1;
      if (hit) {
    ...
    // 6. Hard stop / full target
    let triggerPrice = null, reason = null;
    if (pos.side === 'LONG') {
      if (live <= pos.stop)        { triggerPrice = pos.stop;   reason = pos.breakeven ? 'Trailing Stop' : 'Stop-Loss'; }
      else if (live >= pos.target) { triggerPrice = pos.target; reason = 'Target (Full)'; }
    } else {
      if (live >= pos.stop)        { triggerPrice = pos.stop;   reason = pos.breakeven ? 'Trailing Stop' : 'Stop-Loss'; }
      else if (live <= pos.target) { triggerPrice = pos.target; reason = 'Target (Full)'; }
    }
...
module.exports = async (req, res) => {
  ...
  if (action === 'state') {
    try {
      const data = await kronosStateForDashboard();
  ...
  if (action === 'run') {
    try {
      const sigResult = await generateSignals();
      ...
      // Voor tokens onder drempel hebben we geen signal — fetch hun current via Kronos forecast (in skipped al gevangen)
      // Voor manage: alleen tokens waar we current weten (alle signaltokens). Tokens waar Kronos offline → skip manage daar.
      const manageResult = await manageKronosPositions(currentPrices);
      const execResult = await executeKronosTrades(sigResult.signals);
      return res.status(200).json({
        ok: true,
        ts: new Date().toISOString(),
        signals: sigResult,
